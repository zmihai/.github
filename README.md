...
jobs:
  ...
  gemini_merge:
    name: Gemini Merge
    needs: aggregate
    uses: zmihai/.github/.github/workflows/gemini-merge.yml@v0.6.4
    with:
...
2. Reference reusable workflows using `uses: zmihai/.github/.github/workflows/<name>.yml@v0.6.4`
3. Reference composite actions using `uses: zmihai/.github/actions/<name>@v0.6.4`
...
1. **Pin versions**: Use specific tags (like `@v0.6.4`) or commit SHAs in production.
